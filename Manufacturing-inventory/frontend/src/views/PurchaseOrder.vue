  ...
  <div>
    ...
    <div class="table-card">
      <el-table :data="tableData" border stripe>
        ...
        <el-table-column prop="expectDate" label="预计到货" width="120" />
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            ...
            <el-button link type="success" v-if="row.status === 2" @click="toInbound(row)">入库</el-button>
          </template>
        </el-table-column>
      </el-table>
...
const form = reactive({
  supplierId: null, warehouseId: null, orderDate: '', expectDate: '', remark: ''
})
...
const loadData = async () => {
  try {
    const res = await purchaseApi.orderPage({ pageNum: pageNum.value, pageSize: pageSize.value, ...searchForm })
...
const openDialog = () => {
  Object.assign(form, { supplierId: null, warehouseId: null, orderDate: '', expectDate: '', remark: '' })
